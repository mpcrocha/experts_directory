...
class FriendshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create friendship' do
    assert_difference('Friendship.count') do
      post friendships_url, params: { friendship: { friend: @friendship.friend, member: @friendship.member } }
    end
  ...
  test 'should update friendship' do
    patch friendship_url(@friendship), params: { friendship: { friend: @friendship.friend, member: @friendship.member } }
